<template>
  <section>
    <div class="max-w-[1815px] mx-auto px-6 pt-16 2xl:pt-32">
      ...
      <div class="md:flex justify-between gap-6">
        ...
        <p class="order-1 text-center md:text-left uppercase self-end font-medium dm-sans-medium md:max-w-lg text-light-black">
          Tiramisu sesame
  ...
  <section class="my-16 px-6 lg:my-32 max-w-6xl mx-auto">
    <div class="dm-sans-medium text-light-black text-2xl lg:text-3xl uppercase">
      Pudding cheesecake danish candy candy canes. Jelly-o toffee candy tootsie roll gummi bears macaroon croissant
      <svg class="mx-2 star inline" width="36" height="36" viewBox="0 0 56 56" fill="none"
           xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_49_343)">
          <path d="M0 28H56" stroke="#262626" stroke-width="5" stroke-miterlimit="10"/>
          <path d="M28 0V56" stroke="#262626" stroke-width="5" stroke-miterlimit="10"/>
      ...
      <span class="opacity-50">jujubes cupcake. Tart lemon drops marshmallow macaroon tart chocolate jujubes. Soufflé toffee
      <svg class="mx-2 star inline" width="36" height="36" viewBox="0 0 56 56" fill="none"
           xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_49_343)">
          <path d="M0 28H56" stroke="#262626" stroke-width="5" stroke-miterlimit="10"/>
      ...
      gummies cotton candy
      chocolate cake caramels danish ice cream candy.</span>
    </div>
  </section>
