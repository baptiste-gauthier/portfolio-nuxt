  ...
  <section class="bg-light-black pb-16" id="contact">
    <div class="max-w-[1815px] mx-auto px-6">
      ...
      <div class="lg:flex items-center gap-6 overflow-hidden">
        <h2 data-splitting class="overflow-reveal font-kenoky text-7xl lg:text-9xl uppercase text-white">Contactez</h2>
        <h3 data-splitting class="overflow-reveal dm-sans-bold text-7xl lg:text-9xl uppercase text-white lg:mt-4">Moi</h3>
      </div>
